...
fn main() {
    ...
    println!(
        "   Enabled phases: {:?}",
        default_config.enabled_phases.enabled_phase_names()
    );
    println!(
        "   Batch sizes - nodes: {}, chunks: {}",
        default_config.batch_sizes.nodes, default_config.batch_sizes.doc_chunks
    );
    ...
    println!(
        "   Enabled phases: {:?}",
        custom_config.enabled_phases.enabled_phase_names()
    );
    println!(
        "   Batch sizes - nodes: {}, chunks: {}",
    ...
    println!(
        "   Delays: attempt 0: {}ms, attempt 1: {}ms, attempt 2: {}ms, attempt 3: {}ms",
    ...
    println!(
        "   config1 == config2: {}",
        config1.compute_hash() == config2.compute_hash()
    );
    println!(
        "   config1 == config3: {}",
        config1.compute_hash() == config3.compute_hash()
    );
}
